...
{
    public partial class NORTHWND_UTContext : DbContext
    {
        public NORTHWND_UTContext()
        {
        }

        public NORTHWND_UTContext(DbContextOptions<NORTHWND_UTContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=HPE\\SQL2014;Database=NORTHWND_UT;Trusted_Connection=True;");
//            }
//        }
